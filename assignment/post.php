                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-content text-center">
                            <h2 class="text-white text-uppercase mb-3">Recent Posts</h2>
                            <ol class="breadcrumb d-flex justify-content-center">
                                <li class="breadcrumb-item"><a class="text-uppercase text-white" href="index.html">Home</a></li>

                                <li class="breadcrumb-item text-white active">All Posts </li>
                            </ol>
                        </div>
                    </div>
                </div>
...
if ( strlen($phone) < 8 ){
  ...
  if($status=="OK")
  {
    ...
    $result = mysqli_query($con,"INSERT INTO guest_messages(name,email,message,phone) VALUES ('$name','$email','$message','$phone')");
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        ...
                        <div class="section-heading text-center m-0">
                            ...
                            <a href="contact" class="btn btn-bordered-white mt-4">Contact Me</a>
                        </div>
                    </div>
                </div>
            </div>
