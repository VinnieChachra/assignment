...
?>
    ...
    <!-- Favicon  -->
    <link rel="icon" href="dashboard/uploads/logo/<?php print $xfile?>">
...
?>
                    ...
                    <ul class="navbar-nav items">
                        ...
                        <li class="nav-item">
                            <a href="post.php" class="nav-link">All Post</a>
                        </li>
                       <li class="nav-item">
                            <a href="dashboard/login.php" class="nav-link"><i class="fa fa-lock"></i> Login</a>
                        </li>
...
";
                    ...
                    <ul class="navbar-nav action">
                        <li class="nav-item ml-3">
                            <a href="contact.php" class="btn ml-lg-auto btn-bordered-white"><i class="fas fa-paper-plane contact-icon mr-md-2"></i>Contact Me</a>
                        </li>
                    </ul>
                </div>
            </nav>
